...
export default function Info({navigation,route}) {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.func_button01}>
         <TouchableOpacity style={styles.button02}><Text style={styles.button_text}>{list.first_func}</Text></TouchableOpacity>
         <TouchableOpacity style={styles.button02}><Text style={styles.button_text}>{list.secon_func}</Text></TouchableOpacity>
         <TouchableOpacity style={styles.button02}><Text style={styles.button_text}>{list.third_func}</Text></TouchableOpacity>
         <TouchableOpacity style={styles.button02}><Text style={styles.button_text}>{list.fourth_func}</Text></TouchableOpacity>
      </View>
    </ScrollView>
